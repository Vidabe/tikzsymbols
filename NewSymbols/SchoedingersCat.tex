...
%              \draw (-0.15,.15) arc[start ~angle=180, end ~angle=-90, radius=0.1]
%                arc[start ~angle=90, end ~angle=360, radius=0.1] ;
                
              \fill (0,-0.18)  circle [radius=0.04];
              \def\GGGGG{0.06}
              \def\RRRRRR{0.075}
              \draw (0,\GGGGG) arc[start ~angle=-90, end ~angle=180, radius=\RRRRRR]
