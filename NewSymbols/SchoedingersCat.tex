...
%                    \draw[line ~ width=0.035ex* #1 ]
%                       ({0.1*\case},-0.05) 
%                       .. controls ({0.25*\case},\yi) and ({0.35*\case},\yii) .. 
%                       ({0.4*\case},\yiii);           
...
\SchoedingersCat[1]{1}
\SchoedingersCat[1]{0}
x\SchoedingersCat[1]{0}x

\ExplSyntaxOn

\hbox_set:Nn \l_tmpa_box { \SchoedingersCat {-1} }
\dim_eval:n { \box_wd:N \l_tmpa_box }
\par
\hbox_set:Nn \l_tmpa_box { \SchoedingersCat {0} }
\dim_eval:n { \box_wd:N \l_tmpa_box }
\par
\hbox_set:Nn \l_tmpa_box { \Cat }
\dim_eval:n { \box_wd:N \l_tmpa_box }
